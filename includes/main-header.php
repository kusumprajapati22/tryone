...
?>
	...
	<div class="logo">
		<a href="index.php">
			<!-- Update the logo image source if needed -->
			<img src="assets\banner\logo2.png" alt="Website Logo" style="width:80px;height:55px;">
			<!-- Optional: Add an alt text for better accessibility -->
		</a>
	</div>
</div>
