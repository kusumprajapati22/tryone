...
<!-- Mirrored from deothemes.com/envato/zenna/html/index.html?storefront=envato-elements by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Mar 2025 09:51:58 GMT -->
<head>
                  ...
                  <div class="logo-wrap">
                    <a href="index.html">
                      <img class="logo-dark"
                           ...
                           srcset="img/logo_dark.png 1x, img/logo_dark.png 2x"
                           alt="logo">
                    </a>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="img/shop/collection_1.jpg" width="360" height="620" alt="">
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="img/shop/collection_2.jpg" width="360" height="620" alt="">
                <div class="overlay"></div>
                <div class="promo-inner valign">
                  <h2>accessories</h2>
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="#">
                <img src="img/shop/collection_3.jpg" width="360" height="620" alt="">
                <div class="overlay"></div>
                <div class="promo-inner valign">
                  <h2>for him</h2>
          ...
          <div class="row items-grid">              
              ...
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_1.jpg" width="263" height="350" alt="">
                  </a>
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_2.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_3.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_4.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_5.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_6.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="product-label">
                    <span class="sale">sale</span>
                  </div>
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_7.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
            ...
            <div class="col-md-3 col-xs-6">
              <div class="product-item hover-trigger">
                <div class="product-img">
                  <a href="shop-single.html">
                    <img src="img/shop/shop_item_8.jpg" width="263" height="350" alt="">
                  </a>
                  <div class="hover-overlay">                    
                    <div class="product-actions">
                      <a href="#" class="product-add-to-wishlist">
          ...
          <div class="row">
              ...
              <ul class="product-list-widget">
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_1.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_2.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_3.jpg" width="84" height="112" alt="">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mb-40 products-widget">
              ...
              <ul class="product-list-widget">
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_9.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_10.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_11.jpg" width="84" height="112" alt="">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 mb-40 products-widget">
              ...
              <ul class="product-list-widget">
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_5.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_7.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_8.jpg" width="84" height="112" alt="">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 products-widget last">
              ...
              <ul class="product-list-widget">
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_4.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_6.jpg" width="84" height="112" alt="">
                ...
                <li class="clearfix">
                  <a href="shop-single-product.html">
                    <img src="img/shop/shop_item_12.jpg" width="84" height="112" alt="">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; <script>document.querySelector(".copyright span").innerHTML += new Date().getFullYear();</script> Zenna  |  Made by <a href="https://deothemes.com/">DeoThemes</a>
                </span>
              </div>
...
<!-- Mirrored from deothemes.com/envato/zenna/html/index.html?storefront=envato-elements by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Mar 2025 09:52:27 GMT -->
</html>